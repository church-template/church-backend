...
class NoticeServiceTest {
    ...
    void init() {
        ...
        service = new NoticeService(repository, contentTagService, authorDisplayService, viewCountStore);
    ...
    void get_buffers_view_and_returns_live_count() {
        Notice n = mockNoticeWithVersion(0L);
        when(n.getViewCount()).thenReturn(5L);
        when(repository.findByIdAndDeletedAtIsNull(10L)).thenReturn(Optional.of(n));
        when(viewCountStore.increment("notice", 10L)).thenReturn(3L);
